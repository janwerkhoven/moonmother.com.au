...
export default Component.extend({
  ...
  quotes: [
    {
      text:
        'Their application of skills is exhaustive, they leave no stone unturned and accept the largest of challenges with a warm smile.',
      person: 'Andy Higgins',
      profession: 'Former International Events Manager, Rip Curl'
    },
    {
      text:
        'Of all the Event Managers, Jenny Moon and her Crew at Moon Mother Productions is BEST IN CLASS. They have a very special personal touch and it was obvious that every crew person was very passionate about what they did, which is a rarity in this industry.',
